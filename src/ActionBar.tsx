...
export default class ActionBar extends React.Component<Props> {
    render() {
        return <div className="container-fluid px-0 py-4 bg-white" >
            <div className="row">
                <div className="col-md-3 pl-5">
                    <p className="actionbar-role my-0">Designer</p>
                    <p className="actionbar-screen-title my-0">{this.props.screenTitleDesign}</p>
                ...
                <div className="col-md-3">
                    ...
                    <p className="actionbar-screen-title my-0">{this.props.screenTitleDev}</p>
                    <p className="actionbar-updated my-0">Last updated: </p>
                </div>
                <div className="col-md-3">
